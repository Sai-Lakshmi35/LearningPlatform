    ...
    <div class="ba bb n bc">
     <div style="float: left; padding: 15px; color: black; font-size: 20px; font-weight: 10px;"><b>Learnalite</b></div>
      ...
      <div class="n o bc">
        <span class="ah h g bu bv bw">
          <div class="bx ah">
            <p class="by b bz ca cb">
              <a class="bd be bf bg bh bi bj bk bl bm bn bo bp bq br" href="updateprofile" rel="noopener follow">
                Update
              </a>
            </p>
          </div>
        ...
        <div class="as">
          <span>
            <a class="bd be bf bg bh bi bj bk bl bm bn bo bp bq br" rel="noopener follow" href="emplogin">
